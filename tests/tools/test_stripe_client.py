"""Tests for the shared Stripe client module: extra gate, livemode prefixes, the exact-origin SSRF
...
def test_missing_extra_raises_install_hint(
    ...
    force_missing_import(
        "curl_cffi",
        ["tai42_tools_stripe._internal.tools.stripe_client", "tai42_kit.clients.impl.curl"],
    )
    with pytest.raises(ImportError, match=r"tai42-tools-stripe\[stripe\]"):
        importlib.import_module("tai42_tools_stripe._internal.tools.stripe_client")
